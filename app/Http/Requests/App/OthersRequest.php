...
class OthersRequest extends ValidateRequest
{
    ...
    protected $storeShellQuiz=[
      ...
      , 'e1_proposito_detalhado' => ['max:1700'] //ok
      , 'e2_competencias' => [] //ok
      , 'e2_fragilidades' => [] //ok
      , 'e2_melhor_forca' => [] //ok
      ...
      , 'e2_forca_1' => ['max:600'] //ok
      , 'e2_forca_2' => ['max:600'] //ok
      , 'e2_forca_3' => ['max:600'] //ok
      , 'e2_fragilidade_1' => ['max:600'] //ok
      , 'e2_fragilidade_2' => ['max:600'] //ok
      , 'e2_fragilidade_3' => ['max:600'] //ok1
